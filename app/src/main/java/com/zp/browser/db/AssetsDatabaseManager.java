...
public class AssetsDatabaseManager {
    ...
    public SQLiteDatabase getDatabase (String dbfile) {
        ...
        SharedPreferences dbs = context.getSharedPreferences (AssetsDatabaseManager.class
                .toString (), 0);
        ...
        SQLiteDatabase db = SQLiteDatabase.openDatabase (sfile, null, SQLiteDatabase
