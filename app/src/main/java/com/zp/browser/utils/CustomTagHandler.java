...
public class CustomTagHandler implements Html.TagHandler{
    ...
    public void handleTag(boolean opening, String tag, Editable output,
        ...
        LogUtil.logError(CustomTagHandler.class, "tag.equalsIgnoreCase(span):" + tag.equalsIgnoreCase("span"));
        LogUtil.logError(CustomTagHandler.class,"opening:"+opening);
        LogUtil.logError(CustomTagHandler.class,"tag:"+tag);
    ...
    public void endSpan(String tag, Editable output, XMLReader xmlReader){
        ...
        if (!TextUtils.isEmpty(size)) {
            int fontSizePx = 16;
            if (null != mContext){
                fontSizePx = UIHelper.sp2px(Integer.parseInt(size));
            }
    ...
    private void analysisStyle(int startIndex,int stopIndex,Editable editable,String style){
        ...
        LogUtil.logError(CustomTagHandler.class,"color:::"+color);
        LogUtil.logError(CustomTagHandler.class,"fontSize:::"+fontSize);
        ...
        if (!TextUtils.isEmpty(fontSize)) {
            int fontSizePx = 16;
            if (null != mContext){
                fontSizePx = UIHelper.sp2px(Integer.parseInt(fontSize));
            }
